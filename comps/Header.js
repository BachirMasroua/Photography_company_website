          ...
          <nav>
            <ul className="flex">
              <li className="relative mr-4 group">
                ...
                <div className="absolute w-full h-0.5 bg-gray-500 bottom-0 
                left-0 origin-center scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
              </li>
              <li className="relative mr-4 group">
                <Link className="text-gray-700 hover:text-gray-500" href="/about">
                  About
                </Link>
                <div className="absolute w-full h-0.5 bg-gray-500 bottom-0 left-0 origin-center 
