...
const Contact = () => {
    return ( 
      <div className="flex items-center justify-center lg:h-screen sm:h-fit bg-gradient-to-r from-gray-300 via-green-100 to-green-200">
      <form className="bg-white p-16 my-16 mx-1 rounded-lg shadow-md">
